<template>
    <div class="h-100 w-100 d-flex flex-column justify-content-between" v-if="category">
        ...
        <div class=" ps-4 pe-4 tasksSection d-flex flex-column overflow-auto">
            <div v-if="getTasksByCategoryID(category.id).length == 0" class="h-100 w-100 d-flex justify-content-center align-items-center flex-column">
            ...
            <div v-else>
                <task-component v-for="task in getTasksByCategoryID(category.id)" :key="task.id" :task="task"></task-component>
            </div>
        </div>
...
export default {
    setup() {
        ...
        return {
            ...
            getTasksByCategoryID: store.getTasksByCategoryID,
        }
    },
    data() {
        return {
